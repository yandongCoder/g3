...
tape("Node's groupedBy property only maintain id array in json string.", function(test){
    ...
    test.deepEqual(myGraph.nodes()[3].getJSON(), {id:"grouped:1&2", icon: "", label:"&", mugshot: '', x:0, y:0, radius:15, color:"#359aff", selected:false, groupedBy:{nodes:[1,2], links:[1], attachedLinks: [{link:3, originalTarget:2},{link:2, originalSource:2}]}});
