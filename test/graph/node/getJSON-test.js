...
tape("Node's groupedBy property only maintain id array in json string.", function(test){
    ...
    test.equal(myGraph.nodes()[3].getJSON(), '{"id":"grouped:1&2","label":"&","x":0,"y":0,"radius":15,"color":"#359aff","selected":false,"groupedBy":{"nodes":[1,2],"links":[1],"attachedLinks":[{"link":2,"originalSource":2}]}}');
