...
tape("Transform label, make label text always upward", function(test){
    ...
    test.deepEqual(myGraph.links()[0].getLinkInfoTransform(2), 'rotate(0 50.5 0) translate(50.5 0) scale(0.5) translate(-41 5)');
    test.deepEqual(myGraph.links()[1].getLinkInfoTransform(2), 'rotate(0 59.5 0) translate(59.5 0) scale(0.5) translate(-41 5)');
